...
export REQUEST_TYPE="Update"                              # Create/Update/Delete
export RESOURCEGROUP_LIKE="lambda"  # Name of the Lambda function (part is sufficient), use "lambda" for all the log groups with Lambda functions
